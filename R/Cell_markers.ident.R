...
#' Reset the idents of cell groups
#'
#' @param scrna Seurat objects to be used
#' @param id Intersted cell group
#' @param id.panel Panel of idents of cell group
#' @return seurat obj with idents re-set
#' @export
